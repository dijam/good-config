  ...
  describe('#constructor', () => {
    ...
    it('should set the default config if no node env has been specified', (done) => {
      ...
      const results = {
        ...
        bestartist: {
          name: 'dralban',
          songs: ['it is my life', 'hello afrika'],
        }
      };

      config.load().then((configObject) => {
    ...
    it('should set the default config and overright with env specified value', (done) => {
    ...
    it('should set the default config and overright with env and region specific values', (done) => {
      const config = new Config({
        path: `${__dirname}${configbasePath}defaults`,
        provider: 'FileSystem',
        env: 'zoidberg',
    ...
    it('should set the default config and overright with env and region specific values and env variable overright', (done) => {
      process.env.version = 'v3';
    ...
    it('should set the default config and overright with env and region specific values and env variable overright and use yml', (done) => {
      process.env.version = 'v3';
    ...
    it('should read config synchronously and set the default config and overright with env and region specific values and env variable overright and use yml', (done) => {
      process.env.version = 'v3';
